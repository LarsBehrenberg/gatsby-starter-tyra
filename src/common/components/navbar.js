...
const SliderMenu = props => {
  ...
  return (
    <div
      className={
        'flex flex-column justify-center items-center bg-white fixed top z-max w-100 ease' +
    ...
    >
      <Link
        to="/"
        className={
          'display dark-gray f3 no-underline menu__item pv5' + extraClasses
        }
      >
        {props.siteTitle}
      </Link>
          ...
          <React.Fragment>
            ...
            >
              <div className="w-100 mw8 flex justify-between justify-around-l items-center ph4 pa2-ns">
                ...
                <Link to="/" className="display dark-gray f4 no-underline">
              ...
              <div className="dn w-100 mw5 flex-l justify-around items-center">
                <a
                  ...
                  className="sans-serif light-red f5 no-underline dn dib-l"
                >
                  Sign up
                </a>
